            ...
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="harga_beli" value="{{ old('harga_beli') }}"
                        placeholder="Masukan Harga Beli produk" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="harga_jual" value="{{ old('harga_jual') }}"
                        placeholder="Masukan Harga Jual produk" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="min_stok" value="{{ old('min_stok') }}"
                        placeholder="Masukan min Stok produk" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="deskripsi" placeholder="deskripsi" class="form-control" cols="30" rows="10">{{ old('deskripsi') }}</textarea>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control" name="foto_produk" value="{{ old('foto_produk') }}"
                        placeholder="Masukan Foto produk" required>
