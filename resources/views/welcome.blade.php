   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<div id="page">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="index.html">E-SHOES</a></div>
						</div>
					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
                            ...
                            <div
                                ...
                                <a href="{{ route('login') }}" class="btn btn-dark d-inline-flex mb-md-0 btn-try text-white ">
                                    Masuk
                                </a>
                        ...
                        @auth
                            <div
                                class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
                                <a href="{{ route('dashboard') }}" class="btn d-inline-flex mb-md-0 btn-try btn-dark text-white">
                                    Dashboard
                                </a>
                            </div>
                        @endauth
        ...
        <div class="colorlib-intro">
            ...
            <h2 class="intro text-center mb-4" >About Us</h2>
				<div class="row row-pb-lg">
					...
					<div class="col-sm-6">
						<div class="about-wrap">
							<h2>Tugas Project Akhir Pemograman Web</h2>
							<p>

Selamat datang di E-Shoes, tujuan utama kami adalah memberikan pengalaman belanja sepatu yang menyenangkan dan memuaskan kepada para pecinta sneakers di seluruh dunia. Kami menyediakan berbagai jenis sepatu sneakers terbaru dari merek-merek terkenal dengan kualitas terbaik.
</p>
							<p>Kami memiliki beragam koleksi sepatu sneakers untuk pria, wanita, dan anak-anak. Dari sepatu klasik hingga model terbaru, kami menyediakan pilihan yang beragam untuk memenuhi gaya dan kebutuhan Anda. Semua produk yang kami tawarkan merupakan produk asli dan terjamin kualitasnya.</p>
						</div>
					</div>
				</div>
			</div>
            ...
            <div class="container">
				<div class="row">
					<div class="col partner-col text-center">
						<img style="" src="{{asset('assets/image/rizal.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
						<h4>Muhamad Rizal</h4><hr>
						<h5>0110122070</h5>
					</div>
					<div class="col partner-col text-center">
                        <img src="{{asset('assets/image/salma.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
						<h4>Salma Febrianty</h4><hr>
						<h5>0110122055</h5>
					</div>
					<div class="col partner-col text-center">
                        <img src="{{asset('assets/image/rizky.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
						<h4>Rizky Putra .M</h4><hr>
						<h5>0110122216</h5>
					</div>
					<div class="col partner-col text-center">
                        <img src="{{asset('assets/image/ilham.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
						<h4>M. Rizki Yudi Ilham</h4><hr>
						<h5>0110122261</h5>
					</div>
					<div class="col partner-col text-center">
                        <img src="{{asset('assets/image/lala.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
						<h4>Nabila Putri .S</h4><hr>
						<h5>0110122244</h5>
					</div>
				</div>
			</div>
